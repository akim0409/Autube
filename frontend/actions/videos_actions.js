...
export const fetchVideo = id => dispatch =>
  APIUtil.fetchVideo(id).then(payload => dispatch(receiveVideo(payload)));

export const createVideo = video => dispatch =>
  APIUtil.createVideo(video).then(payload => dispatch(receiveVideo(payload)));

export const updateVideo = video => dispatch =>
  APIUtil.updateVideo(video).then(payload => dispatch(receiveVideo(payload)));
